...
export const FinancialFeatures = () => {
  const t = useTranslations('FinancialFeatures');
    ...
    <div className="relative max-w-screen-xl px-8 py-12 mx-auto md:px-12 lg:px-32">
      <div className="max-w-2xl">
        ...
        <p className="mt-4 text-4xl font-semibold tracking-tighter text-violet-950">
          {t('hao-ping-wu-xu-gou-mai')}
          <span className={bgGradient}>
            {t('zi-dong-shou-huo-zhen-shi-hao-ping')}
          </span>
        </p>
        <p className="max-w-sm mt-4 text-base text-gray-700 lg:text-base">
          {/* 如何让客户有意愿留下好评?  */}
          {t(
            'dang-ke-hu-kan-dao-ni-zai-google-shang-yong-you-geng-duo-de-zheng-mian-ping-jia-shi-ta-men-geng-rong-yi-xin-ren-ni-de-pin-pai-zhe-zhi-jie-ying-xiang-ta-men-de-gou-mai-jue-ce',
          )}
...
const FeaturesGrid = () => {
  ...
  console.log('thas', t.has(features[0]?.title));
